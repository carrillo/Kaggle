...
trainSet <- h2o.importFile(remoteH2O, "/home/carrillo/h2o/data/trainingDecaySubtractedPrincipalComponents_matchedWithTestSet.csv.csv")
testSet <- h2o.importFile(remoteH2O, "/home/carrillo/h2o/data/testDecaySubtractedPrincipalComponents_DepthNumeric.csv")

# Specify the number of principal components to consider
pc_count <- 64
...
setwd( "/Users/carrillo/workspace/Kaggle/output/AfSIS/h2o/" )
