...
public class SOC1stPrediction {
	...
	public SOC1stPrediction( final String trainFileName, final String testFileName ) throws Exception {
	...
	private void preprocessData() throws Exception {
		...
		InstancesManipulation.setClassAttribute( getTrainingData(), "SOC" );
				
		//remove unwanted features
		removeFeatures( new String[]{ "id","pH","Ptransformed","Sand","P", "Ca" }, new String[]{ "id" } );
	...
	public static void main(String[] args) throws Exception
	{
		...
		SOC1stPrediction afsis = new SOC1stPrediction( trainingSet, testSet );
		
		//afsis.train();
		afsis.neurophTrain(); 
		
		afsis.regressionNeurophTest( "resources/AfSIS/predict_SOC.csv" );
		afsis.regressionNeurophTrain( "resources/AfSIS/predictTrain_SOC.csv" );
