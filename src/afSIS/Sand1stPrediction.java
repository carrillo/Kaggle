...
public class Sand1stPrediction {
	...
	public Sand1stPrediction( final String trainFileName, final String testFileName ) throws Exception {
	...
	private void preprocessData() throws Exception {
		...
		InstancesManipulation.setClassAttribute( getTrainingData(), "Sand" );
				
		//remove unwanted features
		removeFeatures( new String[]{ "id","SOC","Ptransformed","pH","P", "Ca" }, new String[]{ "id" } );
	...
	private void neurophTrain() throws Exception {
		...
		resilientBackPropagation.setMaxIterations( 100000 );
		...
		cv.run();
		cv.writeAllObservedVsPredictedPairs( "output/AfSIS/Sand_XValidation.csv" );
		8?
	...
	public static void main(String[] args) throws Exception
	{
		...
		final String predictOut = "resources/AfSIS/predict_sand.csv";
		
		Sand1stPrediction afsis = new Sand1stPrediction( trainingSet, testSet );
		
		//afsis.train();
		afsis.neurophTrain(); 
		
		afsis.regressionNeurophTest( "resources/AfSIS/predict_Sand.csv" );
		afsis.regressionNeurophTrain( "resources/AfSIS/predictTrain_Sand.csv" );
