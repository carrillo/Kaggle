...
public class P1stPrediction {
	...
	public P1stPrediction( final String trainFileName, final String testFileName ) throws Exception {
	...
	private void preprocessData() throws Exception {
		...
		removeFeatures( new String[]{ "id","pH","Ptransformed","Sand","SOC", "Ca" }, new String[]{ "id" } );
	...
	private void neurophTrain() throws Exception {
		...
		/*
		HiddenNodeLearningRule dnlr = new HiddenNodeLearningRule(trainingSet, 100, TransferFunctionType.LINEAR, 
	...
	public static void main(String[] args) throws Exception
	{
		...
		P1stPrediction afsis = new P1stPrediction( trainingSet, testSet );
		
		//afsis.addPolynomialTerms();
		//afsis.train();

		afsis.neurophTrain(); 
		afsis.regressionNeurophTest( "resources/AfSIS/predict_P.csv" );
		afsis.regressionNeurophTrain( "resources/AfSIS/predictTrain_P.csv" );
