...
public class Ca1stPrediction {
	...
	public Ca1stPrediction( final String trainFileName, final String testFileName ) throws Exception {
	...
	private void preprocessData() throws Exception {
		...
		InstancesManipulation.setClassAttribute( getTrainingData(), "Ca" );
				
		//remove unwanted features
		removeFeatures( new String[]{ "id","SOC","Ptransformed","Sand","P", "pH" }, new String[]{ "id" } );
	...
	public static void main(String[] args) throws Exception
	{
		...
		final String predictOut = "resources/AfSIS/predict_Ca.csv";
		
		Ca1stPrediction afsis = new Ca1stPrediction( trainingSet, testSet );
		
		//afsis.train();
		afsis.neurophTrain(); 
		afsis.regressionNeurophTest( "resources/AfSIS/predict_Ca.csv" );
		afsis.regressionNeurophTrain( "resources/AfSIS/predictTrain_Ca.csv" );
