...
fileOut = '/Users/carrillo/workspace/Kaggle/output/AfSIS/predictSVM10_' + st + ".csv"
...
fileOut = '/Users/carrillo/workspace/Kaggle/output/AfSIS/predictSVM10_' + "calibration" + ".csv"
