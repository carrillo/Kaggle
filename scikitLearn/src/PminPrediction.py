...
# create data frame
#df = pd.read_csv('/Users/carrillo/workspace/AlternativeSplicingAnalysis/resources/features/K562_CellPap_noPminZero_noNAs_mean_normalized.csv',header=0)
df = pd.read_csv('/Users/carrillo/workspace/AlternativeSplicingAnalysis/resources/features/K562_CellPap_noPminZero_noNAs_mean_normalized_expanded.csv',header=0)
df.head( 3 )
df.info()
df.describe()
...
input = dfNumeric.iloc()[:,2:]
target = dfNumeric.ix()[:,'pmin']


X_train, X_test, y_train, y_test = train_test_split( input, target, test_size=0.50, random_state=33)
