...
test = pd.read_csv('/Users/carrillo/workspace/Kaggle/resources/AfSIS/testDecaySubtractedSmooth5e-04.csv',header=0)
...
ca_est = svm.SVR(kernel='poly',C=9000.0, degree=2, gamma=0.0009 )
...
# Predict P
p_est = svm.SVR(kernel='rbf',C=17500.0, degree=1, gamma=0.00125 )
...
# Predict pH
pH_est = svm.SVR(kernel='rbf',C=7500.0, degree=1, gamma=0.00075 )
...
# Predict Sand
sand_est = svm.SVR(kernel='rbf',C=12500.0, degree=1, gamma=0 )
...
fileOut = '/Users/carrillo/workspace/Kaggle/output/AfSIS/predictSVM7_' + st + ".csv"
